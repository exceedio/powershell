...
Get-ADUser -Filter * -Properties * -SearchBase $SearchBase | ? {$_.UserPrincipalName -ne $null} | Sort UserPrincipalName | Select UserPrincipalName, GivenName, Surname, Title, Organization, Department, Office, EmailAddress, OfficePhone, MobilePhone, HomePhone, Fax, StreetAddress, City, State, PostalCode | Export-Csv $filename -NoTypeInformation
