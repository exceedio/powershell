...
$updatedIni += ";"
$updatedIni += "disk = check_drivesize ""warn=free<8%"" ""crit=free<2%"" drive=* ""filter=type in ('fixed')"""
$updatedIni += ""
$updatedIni += ";"
...
$updatedIni += ";"
$updatedIni += "mem = check_memory ""warn=used>98%"" ""crit=none"""
$updatedIni += ""
$updatedIni += ";"
...
$updatedIni += ""
$updatedIni += ";"
$updatedIni += "; we gather uptime information for display purposes only but will"
$updatedIni += "; warn if a machine has been up for longer than 365 days because"
$updatedIni += "; generally no Windows machine should be up that long"
$updatedIni += ";"
$updatedIni += "uptime = check_uptime ""warn=uptime>365d"" ""crit=none"""
$updatedIni += ""
